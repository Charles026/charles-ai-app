  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-neutral-800/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 flex flex-col w-[calc(100%-1rem)] h-[calc(100dvh-2rem)] max-h-[calc(100dvh-2rem)] translate-x-[-50%] translate-y-[-50%] rounded-2xl border-0 shadow-lg duration-200 sm:w-[calc(100%-4rem)] sm:max-w-[680px] md:h-[calc(100vh-4rem)] md:max-h-[calc(100vh-4rem)] overflow-hidden backdrop-blur-lg",
          className
        )}
        {...props}
      >
